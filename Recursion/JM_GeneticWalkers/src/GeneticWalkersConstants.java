...
public interface GeneticWalkersConstants
{
	...
	public static final int NUM_WALKERS = 10; // make this no less than 4.
	
	public static final int[][] GENETIC_PAIRINGS = {{0,1},{0,2},{3,4},{1,5},{2,NUM_WALKERS-1}}; // this should have exactly half as many pairs as there are walkers.
