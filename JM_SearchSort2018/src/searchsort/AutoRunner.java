...
public class AutoRunner implements ThreadCompletedDelegate
{
	...
	public AutoRunner()
	{
		...
		System.out.println("Legal sorts: BubbleSort, BozoSort, SelectionSort, InsertionSort, MergeSort, QuickSort, HeapSort, ShellSort RadixSort.");
	...
	public AbstractSearchSortThread sortThreadByName(String name)
	{
		...
		return new ShellSortThread(mainArray,statsThread,this);
